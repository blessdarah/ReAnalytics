...
!(function (t, e) {
    ...
    function Oe(t, e, i, s, n) {
        ...
        return (
            De(t, i, e, function (i, l, h) {
                ...
                if (
                    !Gt(c, t.chartArea, t._minPadding) &&
                    !i.inRange(e.x, e.y, n)
                )
                    return;
                const d = o(e, c);
                d < a
                    ? ((r = [{ element: i, datasetIndex: l, index: h }]),
                      (a = d))
                    : d === a &&
                      r.push({ element: i, datasetIndex: l, index: h });
            }),
            r
        );
    }
    ...
    var Te = {
        modes: {
            ...
            nearest: (t, e, i, s) =>
                Oe(t, Se(e, t), i.axis || "xy", i.intersect, s),
    ...
    class ws {
        ...
        applyStack(t, e, i) {
            const s = this.chart,
                ...
                o = e[t.axis];
            return fs(
                { keys: us(s, !0), values: e._stacks[t.axis] },
                o,
                n.index,
                { mode: i }
            );
        ...
        getMinMax(t, e) {
            const i = this._cachedMeta,
                ...
                r = ((t, e, i) =>
                    t &&
                    !e.hidden &&
                    e._stacked && { keys: us(i, !0), values: null })(
                    e,
                    i,
                    this.chart
                ),
                ...
                c + 6 > o &&
                    ...
                    (l = It(
                        Math.min(
                            ...
                            Math.asin(Ht(a / r, -1, 1)) -
                                Math.asin(Ht(d / r, -1, 1))
                        )
                    )),
    ...
    class Is {
        ...
        unregister(t) {
            ...
            i in e && delete e[i],
                s &&
                    i in xt[s] &&
                    (delete xt[s][i], this.override && delete ft[i]);
        }
    }
    var zs = new (class {
        constructor() {
    ...
    function Qs(t, e) {
        return (
            "top" === t || "bottom" === t || (-1 === Zs.indexOf(t) && "x" === e)
        );
    }
    function Js(t, e) {
        return function (i, s) {
    ...
    class an {
            ...
            e &&
                ...
                J(n, (e) => {
                    const n = e.options,
                        ...
                        r = K(n.type, e.dtype);
                    (void 0 !== n.position &&
                        Qs(n.position, a) === Qs(e.dposition)) ||
        ...
        _handleEvent(t, e) {
            ...
            return (
                ...
                (r = !tt(a, i)),
                (r || e) &&
                    ((this._active = a), this._updateHoverStyles(a, i, e)),
                (this._lastEvent = l),
                r
            );
        }
                        ...
                        (o = u
                            ? Ht(
                                  Math.max(
                                      ...
                                      i
                                          ? 0
                                          : oe(e, l, a.getPixelForValue(c)).hi +
                                                1
                                  ),
                                  n,
                                  s
            ...
            e.fullCircles &&
                (function (t, e, i) {
                    ...
                    for (
                        ...
                        t.stroke();
                    for (
                        t.beginPath(), t.arc(s, n, l, o, o + _t), c = 0;
                        c < r;
                        ++c
                    )
                        t.stroke();
    ...
    class jn extends Ms {
        ...
        get segments() {
            return (
                this._segments ||
                (this._segments = Bi(this, this.options.segment))
            );
        }
        first() {
    ...
    var yo = {
        ...
        afterDatasetsUpdate(t, e, i) {
            ...
            for (a = 0; a < s; ++a)
                (l = n[a]),
                    l && !1 !== l.fill && (l.fill = uo(n, a, i.propagate));
        },
        beforeDraw(t, e, i) {
    ...
    class Vo extends Ms {
        ...
        getTitle(t, e) {
            ...
            let a = [];
            return (
                (a = Oo(a, Ao(s))), (a = Oo(a, Ao(n))), (a = Oo(a, Ao(o))), a
            );
        }
        getBeforeBody(t, e) {
            ...
            const s = (function (t, e) {
                ...
                for (
                    ...
                    (d && v !== o
                        ? (i.push({ value: o }),
                          v < o && P++,
                          Tt(Math.round((v + P * k) * y) / y, o, $o(o, _, t)) &&
                              P++)
                        : v < o && P++);
                    P < M;
                    ++P
            ...
            return (
                ...
                (this._majorUnit =
                    i.major.enabled && "year" !== this._unit
                        ? (function (t) {
                              for (
                                  let e = oa.indexOf(t) + 1, i = oa.length;
                                  e < i;
                                  ++e
                              )
