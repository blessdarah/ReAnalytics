...
(function () {
            ...
            w = {
                ...
                elements: {
                    ...
                    div: function (d) {
                        if (
                            a.plugins.pagebreak &&
                            d.attributes["data-cke-pagebreak"]
                        )
                            return d;
                    ...
                    p: function (d) {
                        ...
                        if (g.thisIsAListItem(a, d))
                            ...
                            a.config.enterMode == CKEDITOR.ENTER_BR &&
                                (delete d.name,
                                d.add(new CKEDITOR.htmlParser.element("br")));
                        }
                        k.createStyleStack(d, c, a);
                    },
                    pre: function (d) {
                        g.thisIsAListItem(a, d) &&
                            g.convertToFakeListItem(a, d);
                        k.createStyleStack(d, c, a);
                    },
                    h1: function (d) {
    ...
    q.lists = {
        ...
        setListStart: function (b) {
            ...
            switch (b.attributes["cke-list-style-type"]) {
                ...
                case "upper-roman":
                    b.attributes.start =
                        g.toArabic(g.getSubsectionSymbol(a[c])) - c;
                    break;
                case "lower-alpha":
                case "upper-alpha":
                    b.attributes.start =
        ...
        setListDir: function (b) {
            ...
            b.forEach(function (b) {
                "li" == b.name &&
                    ("rtl" ==
                    (b.attributes.dir || b.attributes.DIR || "").toLowerCase()
                        ? c++
                        : a++);
        ...
        createList: function (b) {
            return (b.attributes["cke-symbol"].match(/([\da-np-zA-NP-Z]).?/) ||
                [])[1]
            ...
            for (b = 0; b < k.length; b++) {
                ...
                for (f = 0; f < d.length; f++) {
                    ...
                    for (e = c.attributes["cke-list-level"]; e > h.length; ) {
                        ...
                        m = v;
                        e == h.length &&
                            g.setListSymbol(v, c.attributes["cke-symbol"], e);
                    }
                    for (; e < h.length; )
                        h.pop(),
                            (m = h[h.length - 1]),
                ...
                for (f = 0; f < d.length; f++)
                    this.determineListItemValue(d[f]);
            }
        ...
        calculateValue: function (b) {
            ...
            null === c &&
                ((c =
                    void 0 !== a.attributes.start
                        ? parseInt(a.attributes.start, 10)
                        : 1),
                (e = 0));
            return c + (b - e);
        },
        dissolveList: function (b) {
            ...
            g.forEach(m, function (b) {
                var d = b.attributes.type,
                    ...
                    m = c(f, b) + 1;
                d ||
                    (d = n.parseCssText(b.attributes.style)["list-style-type"]);
        ...
        extractFromRtf: function (b) {
            ...
            for (var f = 0; f < b.length; f++)
                if (c.test(b[f])) {
                    ...
                    else if (-1 !== b[f].indexOf("\\jpegblip"))
                        e = "image/jpeg";
                    else continue;
                    a.push({
                        hex: e
                            ? b[f].replace(c, "").replace(/[^\da-fA-F]/g, "")
                            : null,
                        type: e,
                    });
                }
    ...
    q.heuristics = {
        isEdgeListItem: function (b, a) {
            if (
                !CKEDITOR.env.edge ||
                !b.config.pasteFromWord_heuristicsEdgeList
            )
                return !1;
            var c = "";
            a.forEach &&
                ...
                (a.attributes.style &&
                    ...
                    !!a.find(function (b) {
                        ...
                        var e = n.parseCssText(
                            b.attributes && b.attributes.style,
                            !0
                        );
                        if (!e) return !1;
                        var f = e["font-family"] || "";
