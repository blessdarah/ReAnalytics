...
(function () {
        ...
        return {
            elements: {
                ...
                td: function (a) {
                    ...
                    g.background &&
                        ((k = CKEDITOR.tools.style.parse.background(
                            g.background
                        )),
                        k.color &&
                    ...
                    for (var m in d)
                        (k = g[m]
                            ? CKEDITOR.tools.style.border.fromCssRule(g[m])
                            : d[m]),
                            "none" === k.style
                                ? h.setStyle(a, m, "none")
    ...
    p.styles = {
        ...
        normalizedStyles: function (a, b) {
            ...
            var t = CKEDITOR.plugins.pastetools.getConfigValue(
                b,
                "keepZeroMargins"
            );
            r(d);
