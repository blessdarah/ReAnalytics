...
@section('content')
             ...
             <div class="col-xxl-5 offset-xxl-1 col-xl-6 col-lg-6">
                <div class="about__thumb-wrapper">
                   ...
                   <div class="about__banner mt--210">
                      <img src="{{ asset('frontend/assets/img/about/about-banner.jpg') }}" alt="">
                   </div>
                   <div class="about__student ml-270 mt--80">
                      <a href="#">
                         <img src="{{ asset('frontend/assets/img/about/student-3.jpg') }}" alt="">
                         <img src="{{ asset('frontend/assets/img/about/student-3.jpg') }}" alt="">
                         <img src="{{ asset('frontend/assets/img/about/student-2.jpg')}}" alt="">
                         <img src="{{ asset('frontend/assets/img/about/student-1.jpg')}}" alt="">
                      </a>
             ...
             <div class="col-xxl-6 col-xl-6 col-lg-6">
                <div class="about__content pl-70 pr-60 pt-25">
                   <div class="section__title-wrapper mb-25">
                      <h2 class="section__title">Achieve your <br><span class="yellow-bg-big">Goals <img src="{{asset('frontend/assets/img/shape/yellow-bg-2.png')}}" alt=""></span>  with Educal </h2>
    ...
    <section class="testimonial__area pt-145 pb-150" data-background="{{asset('frontend/assets/img/testimonial/home-3/testimonial-bg-3.jpg')}}">
       <div class="container">
          <div class="row">
                      ...
                      <div class="swiper-wrapper">
                        <div class="swiper-slide">
                           <div class="testimonial__nav-thumb">
                               <img src="{{ asset('frontend/assets/img/testimonial/home-3/testi-1.jpg') }}" alt="">
                           </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="testimonial__nav-thumb">
                               <img src="{{ asset('frontend/assets/img/testimonial/home-3/testi-2.jpg') }}" alt="">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="testimonial__nav-thumb">
                               <img src="{{ asset('frontend/assets/img/testimonial/home-3/testi-3.jpg') }}" alt="">
                         </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="testimonial__nav-thumb">
             ...
             <div class="col-xxl-5 offset-xxl-1 col-xl-5 offset-xl-1 col-lg-6 col-md-8">
                <div class="why__content pr-50 mt-40">
                   <div class="section__title-wrapper mb-30">
                      ...
                      <h2 class="section__title">Tools for <span class="yellow-bg yellow-bg-big">Teachers<img src="{{ asset('frontend/assets/img/shape/yellow-bg.png') }}" alt=""></span> and Learners</h2>
