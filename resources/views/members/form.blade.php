<div class="form-group">
    ...
    <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror"
        placeholder="Member full name" value="{{ old('name') ?? ($member->name ?? '') }}">
</div>
...
<div class="form-group">
    ...
    <input type="text" name="position" id="position" class="form-control @error('position') is-invalid @enderror"
        placeholder="Member position" value="{{ old('position') ?? ($member->position ?? '') }}">
</div>
...
<div class="form-group">
    ...
    <input type="text" name="company" id="company" class="form-control @error('company') is-invalid @enderror"
        placeholder="Company or organization name" value="{{ old('company') ?? ($member->company ?? '') }}">
</div>
...
<div class="form-group">
    ...
    <input type="file" class="form-control-file @error('image') is-invalid @enderror" name="image" id="image"
        placeholder="Member cover image">
</div>

<div class="form-group">
    <label for="profile">Member profile information</label>
    <textarea class="form-control @error('profile') is-invalid @enderror" class="editor" name="profile" id="profile"
        rows="5">{{ old('profile') ?? ($member->profile ?? '') }}</textarea>
</div>
