...
<div class="container px-8 mx-auto mt-8 lg:px-36 lg:my-36">
    ...
    <div class="grid grid-cols-12 gap-4 mb-12 lg:gap-8">
        ...
        <div class="col-span-12 px-4 py-6 transition-all bg-white lg:px-8 lg:py-8 group md:col-span-6 lg:col-span-4 hover:shadow-md">
            ...
            <a href="{{$service->url()}}" class="inline-block mt-4 text-blue-500 lg:mt-12">
    ...
    {{-- btn: contact us --}}
    <a href="#" class="hidden px-8 py-4 mt-12 text-center text-white transition-all bg-blue-600 rounded-lg hover:bg-blue-800">
...
<section class="py-8 bg-blue-500">
    <div class="container px-8 mx-auto mt-8 lg:px-36 lg:my-36">
        ...
        <div class="grid grid-cols-12 gap-8">
            @for ($i = 0; $i < 6; $i++) {{-- team member card --}} <div class="flex flex-col items-center content-center col-span-12 py-10 bg-white xl:py-16 md:col-span-6 lg:col-span-4">
                <img src="https://picsum.photos/80" alt="member avatar" class="w-20 h-20 mb-2 rounded-full lg:w-32 lg:h-32 responsive">
