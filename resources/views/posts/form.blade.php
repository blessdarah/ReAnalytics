...
<div class="form-group">
    ...
    <input type="text" name="slug" id="slug" class="form-control" placeholder="Post slug"
...
<div class="form-group">
    ...
    <input type="date" class="form-control @error('published_on') is-invalid @enderror" name="published_on"
        id="published_on" placeholder="dd/mm/yy" value="{{ old('published_on') ?? ($post->published_on ?? '') }}">
</div>
