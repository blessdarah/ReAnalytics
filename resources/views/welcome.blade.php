    ...
    <section class="w-full relative px-10 bg-white pb-48 tails-selected-element">
        ...
        <div class="w-full relative h-32 flex items-center">
            <div
                ...
                <div id="menu"
                     class="absolute md:relative md:w-auto md:rounded-none items-center rounded-xl md:py-0 py-5 md:shadow-none shadow-xl w-full hidden z-20 md:flex md:bg-transparent md:top-auto top-0 md:mt-0 mt-20 bg-white">
                    <nav class="md:space-x-6 lg:space-x-12 flex md:flex-row flex-col h-full font-medium">
                        <a href="#_" class="md:w-auto w-full md:py-0 py-3 text-center">Home</a>
                    ...
                    <div class="h-full font-medium flex items-center md:flex-row flex-col md:pl-6 lg:pl-10">
                        ...
                        <a href="#_"
                           class="px-5 md:mr-0 mr-5 ml-5 text-center lg:ml-7 py-3 border-2 border-gray-900 hover:text-gray-100 hover:bg-gray-900 transition-colors ease-out duration-100 rounded-xl">Admin
                            Login</a>
                    </div>
                </div>
