            ...
            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                <div class="banner__item p-relative mb-40" data-background="assets/img/banner/banner-bg-1.jpg">
                    ...
                    <div class="banner__thumb d-none d-sm-block d-md-none d-lg-block">
                        <img src="{{asset('frontend/assets/img/banner/banner-img-1.png')}}" alt="">
                    </div>
                </div>
            </div>
            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                <div class="banner__item p-relative mb-40" data-background="assets/img/banner/banner-bg-2.jpg">
                    ...
                    <div class="banner__thumb banner__thumb-2 d-none d-sm-block d-md-none d-lg-block">
                        <img src="{{asset('frontend/assets/img/banner/banner-img-2.png')}}" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xxl-4 offset-xxl-4">
                <div class="section__title-wrapper mb-60 text-center">
                    ...
                    <p>Here are the lates up coming events</p>
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <div class="events__item mb-10 hover__active">
                    <div class="events__item-inner d-sm-flex align-items-center justify-content-between white-bg">
                        <div class="events__content">
                            ...
                            <h3 class="events__title"><a href="{{route('app.events.show', $event->id)}}">{{$event->name}}</a></h3>
                        </div>
                        <div class="events__more">
                            <a href="{{route('app.events.show', $event->id)}}" class="link-btn">
                                View More
                                <i class="far fa-arrow-right"></i>
                                <i class="far fa-arrow-right"></i>
                            </a>
...
<section class="price__area pt-60 pb-130">
    <div class="container">
        <div class="row">
            <div class="col-xxl-4 offset-xxl-4">
                <div class="section__title-wrapper mb-60 text-center">
                    <h2 class="section__title">Simple <br> All Inclusive <span class="yellow-bg yellow-bg-big">Pricing<img src="{{asset('frontend/assets/img/shape/yellow-bg.png')}}" alt=""></span></h2>
                            ...
                            <div class="row">
                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                                    <div class="price__item grey-bg mb-30 p-relative">
                                        <div class="price__head">
                                            <h3>Full time</h3>
                                            <p>Perfect for full time students</p>
                                        </div>
                                        <div class="price__tag mb-25">
                                            <h4>350k<span> xaf/ annually</span></h4>
                                        </div>
                                        <div class="price__features mb-40">
                                            <ul>
                                                <li><i class="far fa-check"></i>Course Discussions</li>
                                        ...
                                        <a href="{{route('app.contact-us')}}" class="e-btn e-btn-4">Get Started</a>
                                    </div>
                                </div>
                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                                    <div class="price__item grey-bg mb-30 p-relative">
                                        ...
                                        <div class="price__head">
                                            <h3>Part-time classes</h3>
                                            <p>Perfect for part time students</p>
                                        </div>
                                        <div class="price__tag mb-25">
                                            <h4>180k<span> xaf / annually</span></h4>
                                        </div>
                                        <div class="price__features mb-40">
                                            <ul>
                                                <li><i class="far fa-check"></i>Course Discussions</li>
